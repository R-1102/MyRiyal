...
//    var selectedColor = viewModel.selectedColor
    ...
    var categoryBudgetAmount = viewModel.categoryBudgetAmount
...
//                }
                CustomDropdown(
                    value = categoryType.name.lowercase().replaceFirstChar { it.uppercase() },
...
//                    singleLine = true,
                ...
                CustomTextField(
                    value = formattedDate,
                    onValueChange = {},
//                    label = context.getString(R.string.startDate),
